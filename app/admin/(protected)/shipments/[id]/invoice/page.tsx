  ...
  return (
    <>
      ...
      <article className="admin-invoice">
        <header className="admin-invoice-header"><BrandLogo /><div><span>Shipment invoice</span><strong>{shipment.tracking_number}</strong><small>Issued {formatDate(shipment.created_at)}</small></div></header>
        ...
        <footer className="admin-invoice-footer"><p>Thank you for choosing LinxShip Logistics & Storage.</p><small>This document was generated from the secure operations system. Tracking: {shipment.tracking_number}</small></footer>
      </article>
    </>
  );
}
