! function(t, e) {
    ...
    function r(n) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(s)) : e(Object(s)).forEach(function(t) {
                Object.defineProperty(n, t, Object.getOwnPropertyDescriptor(s, t))
            })
        }
        return n
    }
    c = c && c.hasOwnProperty("default") ? c.default : c, s = s && s.hasOwnProperty("default") ? s.default : s;
    var i = "transitionend";
    var u = {
    ...
    var a = "alert",
        ...
        f = ((b = m.prototype).close = function(t) {
            ...
            var e = u.getSelectorFromElement(t),
                i = !1;
            return (i = e ? document.querySelector(e) : i) || c(t).closest(".alert")[0]
        }, b._triggerCloseEvent = function(t) {
            var e = c.Event(p.CLOSE);
            ...
            c(t).detach().trigger(p.CLOSED).remove()
    ...
    c(document).on(p.CLICK_DATA_API, '[data-dismiss="alert"]', f._handleDismiss(new f)), c.fn[a] = f._jQueryInterface, c.fn[a].Constructor = f, c.fn[a].noConflict = function() {
        return c.fn[a] = d, f._jQueryInterface
    };
    var g = "button",
        v = "bs.button",
        _ = "." + v,
    ...
    c(document).on(_.CLICK_DATA_API, b, function(t) {
        var e, i = t.target;
        !(i = !c(i).hasClass("btn") ? c(i).closest(E)[0] : i) || i.hasAttribute("disabled") || i.classList.contains("disabled") || (e = i.querySelector(C)) && (e.hasAttribute("disabled") || e.classList.contains("disabled")) ? t.preventDefault() : x._jQueryInterface.call(c(i), "toggle")
    }).on(_.FOCUS_BLUR_DATA_API, b, function(t) {
        var e = c(t.target).closest(E)[0];
        c(e).toggleClass("focus", /^focus(in)?$/.test(t.type))
    }), c(window).on(_.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-toggle="buttons"] .btn')), e = 0, i = t.length; e < i; e++) {
            var n = t[e],
                s = n.querySelector(C);
            s.checked || s.hasAttribute("checked") ? n.classList.add(w) : n.classList.remove(w)
        }
    ...
    }), c.fn[g] = x._jQueryInterface, c.fn[g].Constructor = x, c.fn[g].noConflict = function() {
        return c.fn[g] = y, x._jQueryInterface
    };
    var S = "carousel",
        I = "bs.carousel",
        D = "." + I,
        ...
        P = {
            ...
            LOAD_DATA_API: "load" + D + _,
            CLICK_DATA_API: "click" + D + _
        },
        N = "active",
        ...
        H = ((_ = R.prototype).next = function() {
            ...
            c(this._element).off(D), c.removeData(this._element, I), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
        }, _._getConfig = function(t) {
            return t = r({}, k, {}, t), u.typeCheckConfig(S, t, O), t
            ...
            var e = this;
            this._config.keyboard && c(this._element).on(P.KEYDOWN, function(t) {
                return e._keydown(t)
            }), "hover" === this._config.pause && c(this._element).on(P.MOUSEENTER, function(t) {
                return e.pause(t)
            ...
            this._touchSupported && (t = function(t) {
                i._pointerEvent && M[t.originalEvent.pointerType.toUpperCase()] ? i.touchStartX = t.originalEvent.clientX : i._pointerEvent || (i.touchStartX = t.originalEvent.touches[0].clientX)
            }, e = function(t) {
                i._pointerEvent && M[t.originalEvent.pointerType.toUpperCase()] && (i.touchDeltaX = t.originalEvent.clientX - i.touchStartX), i._handleSwipe(), "hover" === i._config.pause && (i.pause(), i.touchTimeout && clearTimeout(i.touchTimeout), i.touchTimeout = setTimeout(function(t) {
                    return i.cycle(t)
                }, 500 + i._config.interval))
            }, c(this._element.querySelectorAll(".carousel-item img")).on(P.DRAG_START, function(t) {
                return t.preventDefault()
            }), this._pointerEvent ? (c(this._element).on(P.POINTERDOWN, t), c(this._element).on(P.POINTERUP, e), this._element.classList.add("pointer-event")) : (c(this._element).on(P.TOUCHSTART, t), c(this._element).on(P.TOUCHMOVE, function(t) {
            ...
            }), c(this._element).on(P.TOUCHEND, e)))
            ...
            t = (s + (t === z ? -1 : 1)) % this._items.length;
            ...
            var e;
            this._indicatorsElement && (e = [].slice.call(this._indicatorsElement.querySelectorAll(".active")), c(e).removeClass(N), (t = this._indicatorsElement.children[this._getItemIndex(t)]) && c(t).addClass(N))
            ...
            var i, n, s, o = this,
                ...
                t = t === L ? (i = "carousel-item-left", n = "carousel-item-next", "left") : (i = "carousel-item-right", n = "carousel-item-prev", "right");
            l && c(l).hasClass(N) ? this._isSliding = !1 : !this._triggerSlideEvent(l, t).isDefaultPrevented() && r && l && (this._isSliding = !0, e && this.pause(), this._setActiveIndicatorElement(l), s = c.Event(P.SLID, {
                relatedTarget: l,
                direction: t,
                from: a,
                to: h
            }), c(this._element).hasClass("slide") ? (c(l).addClass(n), u.reflow(l), c(r).addClass(i), c(l).addClass(i), (h = parseInt(l.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval, this._config.interval = h) : this._config.interval = this._config.defaultInterval || this._config.interval, h = u.getTransitionDurationFromElement(r), c(r).one(u.TRANSITION_END, function() {
                c(l).removeClass(i + " " + n).addClass(N), c(r).removeClass(N + " " + n + " " + i), o._isSliding = !1, setTimeout(function() {
                    return c(o._element).trigger(s)
                }, 0)
            }).emulateTransitionEnd(h)) : (c(r).removeClass(N), c(l).addClass(N), this._isSliding = !1, c(this._element).trigger(s)), e && this.cycle())
            ...
            return this.each(function() {
                ...
                if (t || (t = new R(this, e), c(this).data(I, t)), "number" == typeof n) t.to(n);
            ...
            !n || (e = c(n)[0]) && c(e).hasClass("carousel") && (i = r({}, c(e).data(), {}, c(this).data()), (n = this.getAttribute("data-slide-to")) && (i.interval = !1), R._jQueryInterface.call(c(e), i), n && c(e).data(I).to(n), t.preventDefault())
        }, o(R, null, [{
            key: "VERSION",
            get: function() {
                return "4.4.1"
    ...
    c(document).on(P.CLICK_DATA_API, "[data-slide], [data-slide-to]", H._dataApiClickHandler), c(window).on(P.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, i = t.length; e < i; e++) {
            var n = c(t[e]);
            H._jQueryInterface.call(n, n.data())
        }
    }), c.fn[S] = H._jQueryInterface, c.fn[S].Constructor = H, c.fn[S].noConflict = function() {
        return c.fn[S] = A, H._jQueryInterface
    };
    var W = "collapse",
        q = "bs.collapse",
        _ = "." + q,
        ...
        G = ((_ = X.prototype).toggle = function() {
            c(this._element).hasClass(Q) ? this.hide() : this.show()
        }, _.show = function() {
            var t, e, i, n, s = this;
            this._isTransitioning || c(this._element).hasClass(Q) || (n = this._parent && 0 === (n = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
                return "string" == typeof s._config.parent ? t.getAttribute("data-parent") === s._config.parent : t.classList.contains(Y)
            })).length ? null : n) && (i = c(n).not(this._selector).data(q)) && i._isTransitioning || (t = c.Event(U.SHOW), c(this._element).trigger(t), t.isDefaultPrevented() || (n && (X._jQueryInterface.call(c(n).not(this._selector), "hide"), i || c(n).data(q, null)), e = this._getDimension(), c(this._element).removeClass(Y).addClass(K), this._element.style[e] = 0, this._triggerArray.length && c(this._triggerArray).removeClass(V).attr("aria-expanded", !0), this.setTransitioning(!0), i = "scroll" + (e[0].toUpperCase() + e.slice(1)), n = u.getTransitionDurationFromElement(this._element), c(this._element).one(u.TRANSITION_END, function() {
                c(s._element).removeClass(K).addClass(Y).addClass(Q), s._element.style[e] = "", s.setTransitioning(!1), c(s._element).trigger(U.SHOWN)
            }).emulateTransitionEnd(n), this._element.style[e] = this._element[i] + "px"))
        }, _.hide = function() {
            var t = this;
            if (!this._isTransitioning && c(this._element).hasClass(Q)) {
                var e = c.Event(U.HIDE);
                if (c(this._element).trigger(e), !e.isDefaultPrevented()) {
                    e = this._getDimension();
                    this._element.style[e] = this._element.getBoundingClientRect()[e] + "px", u.reflow(this._element), c(this._element).addClass(K).removeClass(Y).removeClass(Q);
                    var i = this._triggerArray.length;
                    if (0 < i)
                        for (var n = 0; n < i; n++) {
                            var s = this._triggerArray[n],
                                o = u.getSelectorFromElement(s);
                            null !== o && (c([].slice.call(document.querySelectorAll(o))).hasClass(Q) || c(s).addClass(V).attr("aria-expanded", !1))
                        }
                    this.setTransitioning(!0), this._element.style[e] = "";
                    e = u.getTransitionDurationFromElement(this._element);
                    c(this._element).one(u.TRANSITION_END, function() {
                        t.setTransitioning(!1), c(t._element).removeClass(K).addClass(Y).trigger(U.HIDDEN)
            ...
            c.removeData(this._element, q), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
        }, _._getConfig = function(t) {
            return (t = r({}, B, {}, t)).toggle = Boolean(t.toggle), u.typeCheckConfig(W, t, $), t
            ...
            return c(e).each(function(t, e) {
                i._addAriaAndCollapsedClass(X._getTargetFromElement(e), [e])
            }), t
        }, _._addAriaAndCollapsedClass = function(t, e) {
            t = c(t).hasClass(Q);
            e.length && c(e).toggleClass(V, !t).attr("aria-expanded", t)
        }, X._getTargetFromElement = function(t) {
            ...
            return this.each(function() {
                var t = c(this),
                    e = t.data(q),
                    i = r({}, B, {}, t.data(), {}, "object" == typeof n && n ? n : {});
                if (!e && i.toggle && /show|hide/.test(n) && (i.toggle = !1), e || (e = new X(this, i), t.data(q, e)), "string" == typeof n) {
    ...
    c(document).on(U.CLICK_DATA_API, Z, function(t) {
    ...
    }), c.fn[W] = G._jQueryInterface, c.fn[W].Constructor = G, c.fn[W].noConflict = function() {
        return c.fn[W] = F, G._jQueryInterface
    };
    var J = "dropdown",
        tt = "bs.dropdown",
        et = "." + tt,
        ...
        st = {
            ...
            SHOWN: "shown" + et,
            CLICK: "click" + et,
            CLICK_DATA_API: "click" + et + _,
            KEYDOWN_DATA_API: "keydown" + et + _,
            KEYUP_DATA_API: "keyup" + et + _
        },
        ot = "disabled",
        rt = "show",
        ...
        dt = ((_ = pt.prototype).toggle = function() {
            var t;
            this._element.disabled || c(this._element).hasClass(ot) || (t = c(this._menu).hasClass(rt), pt._clearMenus(), t || this.show(!0))
        }, _.show = function(t) {
            if (void 0 === t && (t = !1), !(this._element.disabled || c(this._element).hasClass(ot) || c(this._menu).hasClass(rt))) {
                var e = {
                        relatedTarget: this._element
                    },
                    i = c.Event(st.SHOW, e),
                    n = pt._getParentFromElement(this._element);
                if (c(n).trigger(i), !i.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        if (void 0 === s) throw new TypeError("Bootstrap's dropdowns require Popper.js (https://popper.js.org/)");
                        t = this._element;
                        "parent" === this._config.reference ? t = n : u.isElement(this._config.reference) && (t = this._config.reference, void 0 !== this._config.reference.jquery && (t = this._config.reference[0])), "scrollParent" !== this._config.boundary && c(n).addClass("position-static"), this._popper = new s(t, this._menu, this._getPopperConfig())
                    }
                    "ontouchstart" in document.documentElement && 0 === c(n).closest(".navbar-nav").length && c(document.body).children().on("mouseover", null, c.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), c(this._menu).toggleClass(rt), c(n).toggleClass(rt).trigger(c.Event(st.SHOWN, e))
                }
            }
        }, _.hide = function() {
            var t, e, i;
            this._element.disabled || c(this._element).hasClass(ot) || !c(this._menu).hasClass(rt) || (t = {
                relatedTarget: this._element
            }, e = c.Event(st.HIDE, t), i = pt._getParentFromElement(this._element), c(i).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), c(this._menu).toggleClass(rt), c(i).toggleClass(rt).trigger(c.Event(st.HIDDEN, t))))
        }, _.dispose = function() {
            c.removeData(this._element, tt), c(this._element).off(et), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
        }, _.update = function() {
            this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate()
        }, _._addEventListeners = function() {
            var e = this;
            c(this._element).on(st.CLICK, function(t) {
                t.preventDefault(), t.stopPropagation(), e.toggle()
            })
        }, _._getConfig = function(t) {
            return t = r({}, this.constructor.Default, {}, c(this._element).data(), {}, t), u.typeCheckConfig(J, t, this.constructor.DefaultType), t
        }, _._getMenuElement = function() {
            var t;
            return this._menu || (t = pt._getParentFromElement(this._element)) && (this._menu = t.querySelector(ht)), this._menu
        }, _._getPlacement = function() {
            var t = c(this._element.parentNode),
                e = "bottom-start";
            return t.hasClass("dropup") ? (e = "top-start", c(this._menu).hasClass(at) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : c(this._menu).hasClass(at) && (e = "bottom-end"), e
        }, _._detectNavbar = function() {
            return 0 < c(this._element).closest(".navbar").length
        }, _._getOffset = function() {
            var e = this,
                t = {};
            ...
            return this.each(function() {
                var t = c(this).data(tt);
                if (t || (t = new pt(this, "object" == typeof e ? e : null), c(this).data(tt, t)), "string" == typeof e) {
                    if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                    t[e]()
                }
            })
        }, pt._clearMenus = function(t) {
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                for (var e = [].slice.call(document.querySelectorAll(lt)), i = 0, n = e.length; i < n; i++) {
                    var s, o, r = pt._getParentFromElement(e[i]),
                        a = c(e[i]).data(tt),
                        l = {
                            relatedTarget: e[i]
                        };
                    t && "click" === t.type && (l.clickEvent = t), a && (s = a._menu, !c(r).hasClass(rt) || t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && c.contains(r, t.target) || (o = c.Event(st.HIDE, l), c(r).trigger(o), o.isDefaultPrevented() || ("ontouchstart" in document.documentElement && c(document.body).children().off("mouseover", null, c.noop), e[i].setAttribute("aria-expanded", "false"), a._popper && a._popper.destroy(), c(s).removeClass(rt), c(r).removeClass(rt).trigger(c.Event(st.HIDDEN, l)))))
                }
        }, pt._getParentFromElement = function(t) {
            var e, i = u.getSelectorFromElement(t);
            return (e = i ? document.querySelector(i) : e) || t.parentNode
        }, pt._dataApiKeydownHandler = function(t) {
            var e, i, n;
            (/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || c(t.target).closest(ht).length) : !nt.test(t.which)) || (t.preventDefault(), t.stopPropagation(), this.disabled || c(this).hasClass(ot)) || (n = pt._getParentFromElement(this), !(i = c(n).hasClass(rt)) && 27 === t.which || (i && (!i || 27 !== t.which && 32 !== t.which) ? 0 !== (e = [].slice.call(n.querySelectorAll(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)")).filter(function(t) {
                return c(t).is(":visible")
            })).length && (i = e.indexOf(t.target), 38 === t.which && 0 < i && i--, 40 === t.which && i < e.length - 1 && i++, e[i = i < 0 ? 0 : i].focus()) : (27 === t.which && (n = n.querySelector(lt), c(n).trigger("focus")), c(this).trigger("click"))))
        }, o(pt, null, [{
            key: "VERSION",
            get: function() {
                return "4.4.1"
    ...
    c(document).on(st.KEYDOWN_DATA_API, lt, dt._dataApiKeydownHandler).on(st.KEYDOWN_DATA_API, ht, dt._dataApiKeydownHandler).on(st.CLICK_DATA_API + " " + st.KEYUP_DATA_API, dt._clearMenus).on(st.CLICK_DATA_API, lt, function(t) {
        t.preventDefault(), t.stopPropagation(), dt._jQueryInterface.call(c(this), "toggle")
    }).on(st.CLICK_DATA_API, ".dropdown form", function(t) {
        t.stopPropagation()
    }), c.fn[J] = dt._jQueryInterface, c.fn[J].Constructor = dt, c.fn[J].noConflict = function() {
        return c.fn[J] = it, dt._jQueryInterface
    };
    var ft = "modal",
        mt = "bs.modal",
        gt = "." + mt,
        ...
        wt = {
            HIDE: "hide" + gt,
            HIDE_PREVENTED: "hidePrevented" + gt,
            HIDDEN: "hidden" + gt,
            SHOW: "show" + gt,
            SHOWN: "shown" + gt,
            FOCUSIN: "focusin" + gt,
        ...
        Et = "show",
        xt = "modal-static",
        Tt = ".navbar-sticky, .fixed-bottom, .is-fixed, .sticky-top",
        St = ".sticky-top",
        It = ((_ = Dt.prototype).toggle = function(t) {
            return this._isShown ? this.hide() : this.show(t)
        }, _.show = function(t) {
            var e, i = this;
            this._isShown || this._isTransitioning || (c(this._element).hasClass(Ct) && (this._isTransitioning = !0), e = c.Event(wt.SHOW, {
                relatedTarget: t
            }), c(this._element).trigger(e), this._isShown || e.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), c(this._element).on(wt.CLICK_DISMISS, '[data-dismiss="modal"]', function(t) {
                return i.hide(t)
            }), c(this._dialog).on(wt.MOUSEDOWN_DISMISS, function() {
                c(i._element).one(wt.MOUSEUP_DISMISS, function(t) {
            ...
            var e = this;
            t && t.preventDefault(), this._isShown && !this._isTransitioning && (t = c.Event(wt.HIDE), c(this._element).trigger(t), this._isShown && !t.isDefaultPrevented() && (this._isShown = !1, (t = c(this._element).hasClass(Ct)) && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), c(document).off(wt.FOCUSIN), c(this._element).removeClass(Et), c(this._element).off(wt.CLICK_DISMISS), c(this._dialog).off(wt.MOUSEDOWN_DISMISS), t ? (t = u.getTransitionDurationFromElement(this._element), c(this._element).one(u.TRANSITION_END, function(t) {
                return e._hideModal(t)
            }).emulateTransitionEnd(t)) : this._hideModal()))
        }, _.dispose = function() {
            [window, this._element, this._dialog].forEach(function(t) {
                return c(t).off(gt)
            }), c(document).off(wt.FOCUSIN), c.removeData(this._element, mt), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
        }, _.handleUpdate = function() {
            this._adjustDialog()
        }, _._getConfig = function(t) {
            return t = r({}, _t, {}, t), u.typeCheckConfig(ft, t, yt), t
        }, _._triggerBackdropTransition = function() {
            var t, e = this;
            "static" === this._config.backdrop ? (t = c.Event(wt.HIDE_PREVENTED), c(this._element).trigger(t), t.defaultPrevented || (this._element.classList.add(xt), t = u.getTransitionDurationFromElement(this._element), c(this._element).one(u.TRANSITION_END, function() {
                e._element.classList.remove(xt)
            }).emulateTransitionEnd(t), this._element.focus())) : this.hide()
        }, _._showElement = function(t) {
            var e = this,
                i = c(this._element).hasClass(Ct),
                n = this._dialog ? this._dialog.querySelector(".modal-body") : null;

            function s() {
                e._config.focus && e._element.focus(), e._isTransitioning = !1, c(e._element).trigger(o)
            }
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), c(this._dialog).hasClass("modal-dialog-scrollable") && n ? n.scrollTop = 0 : this._element.scrollTop = 0, i && u.reflow(this._element), c(this._element).addClass(Et), this._config.focus && this._enforceFocus();
            var o = c.Event(wt.SHOWN, {
                relatedTarget: t
            });
            i ? (i = u.getTransitionDurationFromElement(this._dialog), c(this._dialog).one(u.TRANSITION_END, s).emulateTransitionEnd(i)) : s()
        }, _._enforceFocus = function() {
            var e = this;
            c(document).off(wt.FOCUSIN).on(wt.FOCUSIN, function(t) {
                document !== t.target && e._element !== t.target && 0 === c(e._element).has(t.target).length && e._element.focus()
            })
        }, _._setEscapeEvent = function() {
            var e = this;
            this._isShown && this._config.keyboard ? c(this._element).on(wt.KEYDOWN_DISMISS, function(t) {
                27 === t.which && e._triggerBackdropTransition()
            }) : this._isShown || c(this._element).off(wt.KEYDOWN_DISMISS)
        }, _._setResizeEvent = function() {
            var e = this;
            this._isShown ? c(window).on(wt.RESIZE, function(t) {
                return e.handleUpdate(t)
            }) : c(window).off(wt.RESIZE)
        }, _._hideModal = function() {
            var t = this;
            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
                c(document.body).removeClass(bt), t._resetAdjustments(), t._resetScrollbar(), c(t._element).trigger(wt.HIDDEN)
            })
        }, _._removeBackdrop = function() {
            this._backdrop && (c(this._backdrop).remove(), this._backdrop = null)
        }, _._showBackdrop = function(t) {
            var e, i = this,
                n = c(this._element).hasClass(Ct) ? Ct : "";
            this._isShown && this._config.backdrop ? (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", n && this._backdrop.classList.add(n), c(this._backdrop).appendTo(document.body), c(this._element).on(wt.CLICK_DISMISS, function(t) {
                i._ignoreBackdropClick ? i._ignoreBackdropClick = !1 : t.target === t.currentTarget && i._triggerBackdropTransition()
            }), n && u.reflow(this._backdrop), c(this._backdrop).addClass(Et), t && (n ? (e = u.getTransitionDurationFromElement(this._backdrop), c(this._backdrop).one(u.TRANSITION_END, t).emulateTransitionEnd(e)) : t())) : !this._isShown && this._backdrop ? (c(this._backdrop).removeClass(Et), n = function() {
                i._removeBackdrop(), t && t()
            }, c(this._element).hasClass(Ct) ? (e = u.getTransitionDurationFromElement(this._backdrop), c(this._backdrop).one(u.TRANSITION_END, n).emulateTransitionEnd(e)) : n()) : t && t()
            ...
            var t, e, s = this;
            this._isBodyOverflowing && (t = [].slice.call(document.querySelectorAll(Tt)), e = [].slice.call(document.querySelectorAll(St)), c(t).each(function(t, e) {
                var i = e.style.paddingRight,
                    n = c(e).css("padding-right");
                c(e).data("padding-right", i).css("padding-right", parseFloat(n) + s._scrollbarWidth + "px")
            }), c(e).each(function(t, e) {
                var i = e.style.marginRight,
                    n = c(e).css("margin-right");
                c(e).data("margin-right", i).css("margin-right", parseFloat(n) - s._scrollbarWidth + "px")
            }), t = document.body.style.paddingRight, e = c(document.body).css("padding-right"), c(document.body).data("padding-right", t).css("padding-right", parseFloat(e) + this._scrollbarWidth + "px")), c(document.body).addClass(bt)
            ...
            return this.each(function() {
                var t = c(this).data(mt),
                    e = r({}, _t, {}, c(this).data(), {}, "object" == typeof i && i ? i : {});
                if (t || (t = new Dt(this, e), c(this).data(mt, t)), "string" == typeof i) {
                    if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                    t[i](n)
    ...
    c(document).on(wt.CLICK_DATA_API, '[data-toggle="modal"]', function(t) {
        var e, i = this,
            n = u.getSelectorFromElement(this);
        n && (e = document.querySelector(n));
        n = c(e).data(mt) ? "toggle" : r({}, c(e).data(), {}, c(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var s = c(e).one(wt.SHOW, function(t) {
            t.isDefaultPrevented() || s.one(wt.HIDDEN, function() {
                c(i).is(":visible") && i.focus()
            })
        });
        It._jQueryInterface.call(c(e), n, this)
    }), c.fn[ft] = It._jQueryInterface, c.fn[ft].Constructor = It, c.fn[ft].noConflict = function() {
        return c.fn[ft] = vt, It._jQueryInterface
    };
    ...
    function Lt(t, s, e) {
        ...
        for (var t = (new window.DOMParser).parseFromString(t, "text/html"), o = Object.keys(s), r = [].slice.call(t.body.querySelectorAll("*")), i = 0, n = r.length; i < n; i++) ! function(t) {
            var e = r[t],
            ...
            t.forEach(function(t) {
                ! function(t, e) {
                    ...
                    if (-1 !== e.indexOf(i)) return -1 === At.indexOf(i) || Boolean(t.nodeValue.match(kt) || t.nodeValue.match(Ot));
    ...
    var zt = "tooltip",
        ...
        Yt = "hover",
        Kt = "focus",
        Vt = ((_ = Zt.prototype).enable = function() {
            this._isEnabled = !0
        }, _.disable = function() {
            this._isEnabled = !1
            ...
            var t, i, n = c.Event(this.constructor.Event.SHOW);
            this.isWithContent() && this._isEnabled && (c(this.element).trigger(n), i = u.findShadowRoot(this.element), t = c.contains(null !== i ? i : this.element.ownerDocument.documentElement, this.element), !n.isDefaultPrevented() && t && (i = this.getTipElement(), n = u.getUID(this.constructor.NAME), i.setAttribute("id", n), this.element.setAttribute("aria-describedby", n), this.setContent(), this.config.animation && c(i).addClass(Ut), t = "function" == typeof this.config.placement ? this.config.placement.call(this, i, this.element) : this.config.placement, n = this._getAttachment(t), this.addAttachmentClass(n), t = this._getContainer(), c(i).data(this.constructor.DATA_KEY, this), c.contains(this.element.ownerDocument.documentElement, this.tip) || c(i).appendTo(t), c(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new s(this.element, i, this._getPopperConfig(n)), c(i).addClass(Qt), "ontouchstart" in document.documentElement && c(document.body).children().on("mouseover", null, c.noop), n = function() {
                e.config.animation && e._fixTransition();
                var t = e._hoverState;
                e._hoverState = null, c(e.element).trigger(e.constructor.Event.SHOWN), "out" === t && e._leave(null, e)
            }, c(this.tip).hasClass(Ut) ? (i = u.getTransitionDurationFromElement(this.tip), c(this.tip).one(u.TRANSITION_END, n).emulateTransitionEnd(i)) : n()))
        }, _.hide = function(t) {
            function e() {
                i._hoverState !== Bt && n.parentNode && n.parentNode.removeChild(n), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), c(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), t && t()
            }
            var i = this,
                n = this.getTipElement(),
                s = c.Event(this.constructor.Event.HIDE);
            c(this.element).trigger(s), s.isDefaultPrevented() || (c(n).removeClass(Qt), "ontouchstart" in document.documentElement && c(document.body).children().off("mouseover", null, c.noop), this._activeTrigger.click = !1, this._activeTrigger[Kt] = !1, this._activeTrigger[Yt] = !1, c(this.tip).hasClass(Ut) ? (s = u.getTransitionDurationFromElement(n), c(n).one(u.TRANSITION_END, e).emulateTransitionEnd(s)) : e(), this._hoverState = "")
        }, _.update = function() {
            null !== this._popper && this._popper.scheduleUpdate()
        }, _.isWithContent = function() {
            return Boolean(this.getTitle())
        }, _.addAttachmentClass = function(t) {
            c(this.getTipElement()).addClass(Mt + "-" + t)
        }, _.getTipElement = function() {
            return this.tip = this.tip || c(this.config.template)[0], this.tip
        }, _.setContent = function() {
            var t = this.getTipElement();
            this.setElementContent(c(t.querySelectorAll(".tooltip-inner")), this.getTitle()), c(t).removeClass(Ut + " " + Qt)
        }, _.setElementContent = function(t, e) {
            "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Lt(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? c(e).parent().is(t) || t.empty().append(e) : t.text(c(e).text())
        }, _.getTitle = function() {
            var t = this.element.getAttribute("data-original-title");
            return t || ("function" == typeof this.config.title ? this.config.title.call(this.element) : this.config.title)
        }, _._getPopperConfig = function(t) {
            var e = this;
            return r({}, {
                placement: t,
                modifiers: {
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                ...
                "click" === t ? c(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                    return i.toggle(t)
                }) : "manual" !== t && (e = t === Yt ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN, t = t === Yt ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT, c(i.element).on(e, i.config.selector, function(t) {
                    return i._enter(t)
        ...
        }, _._leave = function(t, e) {
            var i = this.constructor.DATA_KEY;
            (e = e || c(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), c(t.currentTarget).data(i, e)), t && (e._activeTrigger["focusout" === t.type ? Kt : Yt] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = "out", e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
            ...
            return Object.keys(e).forEach(function(t) {
                ...
                show: t.delay,
                hide: t.delay
            }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), u.typeCheckConfig(zt, t, this.constructor.DefaultType), t.sanitize && (t.template = Lt(t.template, t.whiteList, t.sanitizeFn)), t
            ...
            null === t.getAttribute("x-placement") && (c(t).removeClass(Ut), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
        }, Zt._jQueryInterface = function(i) {
            return this.each(function() {
                var t = c(this).data(Pt),
                    e = "object" == typeof i && i;
                if ((t || !/dispose|hide/.test(i)) && (t || (t = new Zt(this, e), c(this).data(Pt, t)), "string" == typeof i)) {
                    if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                    t[i]()
                }
            })
    ...
    c.fn[zt] = Vt._jQueryInterface, c.fn[zt].Constructor = Vt, c.fn[zt].noConflict = function() {
        return c.fn[zt] = jt, Vt._jQueryInterface
    };
    var Gt = "popover",
        Xt = "bs.popover",
        Jt = "." + Xt,
        ...
        re = function(t) {
            ...
            return i.isWithContent = function() {
                ...
                c(this.getTipElement()).addClass(ee + "-" + t)
                ...
                return this.each(function() {
                    var t = c(this).data(Xt),
                        e = "object" == typeof i ? i : null;
                    if ((t || !/dispose|hide/.test(i)) && (t || (t = new n(this, e), c(this).data(Xt, t)), "string" == typeof i)) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i]()
                    }
                })
    ...
    c.fn[Gt] = re._jQueryInterface, c.fn[Gt].Constructor = re, c.fn[Gt].noConflict = function() {
        return c.fn[Gt] = te, re._jQueryInterface
    };
    var ae = "scrollspy",
        le = "bs.scrollspy",
        he = "." + le,
        ...
        ve = ".list-group-item",
        _e = "position",
        ye = ((_ = we.prototype).refresh = function() {
            var e = this,
            ...
            this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(t) {
                ...
                if (e = i ? document.querySelector(i) : e) {
                    ...
                    if (t.width || t.height) return [c(e)[n]().top + s, i]
                }
                return null
            }).filter(function(t) {
                return t
            ...
            c.removeData(this._element, le), c(this._scrollElement).off(he), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
        }, _._getConfig = function(t) {
            var e;
            return "string" != typeof(t = r({}, ue, {}, "object" == typeof t && t ? t : {})).target && ((e = c(t.target).attr("id")) || (e = u.getUID(ae), c(t.target).attr("id", e)), t.target = "#" + e), u.typeCheckConfig(ae, t, de), t
            ...
            t.hasClass("dropdown-item") ? (t.closest(".dropdown").find(".dropdown-toggle").addClass(fe), t.addClass(fe)) : (t.addClass(fe), t.parents(me).prev(ge + ", " + ve).addClass(fe), t.parents(me).prev(".nav-item").children(ge).addClass(fe)), c(this._scrollElement).trigger(pe.ACTIVATE, {
                relatedTarget: e
            })
        }, _._clear = function() {
            ...
            return this.each(function() {
                var t = c(this).data(le);
                if (t || (t = new we(this, "object" == typeof e && e), c(this).data(le, t)), "string" == typeof e) {
                    if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                    t[e]()
                }
            })
    ...
    function we(t, e) {
        var i = this;
        this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + ge + "," + this._config.target + " " + ve + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, c(this._scrollElement).on(pe.SCROLL, function(t) {
            return i._process(t)
        }), this.refresh(), this._process()
    }
    c(window).on(pe.LOAD_DATA_API, function() {
        ...
        return c.fn[ae] = ce, ye._jQueryInterface
    };
    var be = "bs.tab",
        _ = "." + be,
        Ce = c.fn.tab,
        ...
        Te = ".active",
        Se = "> li > .active",
        Ie = ((_ = De.prototype).show = function() {
            var t, e, i, n, s, o, r = this;
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && c(this._element).hasClass(xe) || c(this._element).hasClass("disabled") || (o = c(this._element).closest(".nav, .list-group")[0], e = u.getSelectorFromElement(this._element), o && (s = "UL" === o.nodeName || "OL" === o.nodeName ? Se : Te, i = (i = c.makeArray(c(o).find(s)))[i.length - 1]), n = c.Event(Ee.HIDE, {
                relatedTarget: this._element
            }), s = c.Event(Ee.SHOW, {
                relatedTarget: i
            }), i && c(i).trigger(n), c(this._element).trigger(s), s.isDefaultPrevented() || n.isDefaultPrevented() || (e && (t = document.querySelector(e)), this._activate(this._element, o), o = function() {
                var t = c.Event(Ee.HIDDEN, {
    ...
    c(document).on(Ee.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(), Ie._jQueryInterface.call(c(this), "show")
    }), c.fn.tab = Ie._jQueryInterface, c.fn.tab.Constructor = Ie, c.fn.tab.noConflict = function() {
        return c.fn.tab = Ce, Ie._jQueryInterface
    };
    var Ae = "toast",
        ke = "bs.toast",
        _ = "." + ke,
        ...
        Me = ((_ = He.prototype).show = function() {
            var t, e = this,
                i = c.Event(Le.SHOW);
            c(this._element).trigger(i), i.isDefaultPrevented() || (this._config.animation && this._element.classList.add("fade"), t = function() {
                e._element.classList.remove(Pe), e._element.classList.add(ze), c(e._element).trigger(Le.SHOWN), e._config.autohide && (e._timeout = setTimeout(function() {
                    e.hide()
                }, e._config.delay))
            }, this._element.classList.remove("hide"), u.reflow(this._element), this._element.classList.add(Pe), this._config.animation ? (i = u.getTransitionDurationFromElement(this._element), c(this._element).one(u.TRANSITION_END, t).emulateTransitionEnd(i)) : t())
        }, _.hide = function() {
            var t;
            this._element.classList.contains(ze) && (t = c.Event(Le.HIDE), c(this._element).trigger(t), t.isDefaultPrevented() || this._close())
        }, _.dispose = function() {
            clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(ze) && this._element.classList.remove(ze), c(this._element).off(Le.CLICK_DISMISS), c.removeData(this._element, ke), this._element = null, this._config = null
        }, _._getConfig = function(t) {
            return t = r({}, je, {}, c(this._element).data(), {}, "object" == typeof t && t ? t : {}), u.typeCheckConfig(Ae, t, this.constructor.DefaultType), t
        }, _._setListeners = function() {
            var t = this;
            c(this._element).on(Le.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
                return t.hide()
            })
        }, _._close = function() {
            function t() {
                i._element.classList.add("hide"), c(i._element).trigger(Le.HIDDEN)
            }
            var e, i = this;
            this._element.classList.remove(ze), this._config.animation ? (e = u.getTransitionDurationFromElement(this._element), c(this._element).one(u.TRANSITION_END, t).emulateTransitionEnd(e)) : t()
        }, He._jQueryInterface = function(i) {
            return this.each(function() {
                var t = c(this),
                    e = t.data(ke);
                if (e || (e = new He(this, "object" == typeof i && i), t.data(ke, e)), "string" == typeof i) {
                    if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                    e[i](this)
                }
            })
    ...
    c.fn[Ae] = Me._jQueryInterface, c.fn[Ae].Constructor = Me, c.fn[Ae].noConflict = function() {
        return c.fn[Ae] = Oe, Me._jQueryInterface
    }, t.Alert = f, t.Button = x, t.Carousel = H, t.Collapse = G, t.Dropdown = dt, t.Modal = It, t.Popover = re, t.Scrollspy = ye, t.Tab = Ie, t.Toast = Me, t.Tooltip = Vt, t.Util = u, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}),
function() {
    ...
    window.JQClass = function() {}, JQClass.classes = {}, JQClass.extend = function t(e) {
        ...
        var n, o = new this;
        for (n in c = !1, e)
            if ("function" == typeof e[n] && "function" == typeof s[n]) o[n] = function(i, n) {
                return function() {
                    var t = this._super;
            ...
            else if ("object" == typeof e[n] && "object" == typeof s[n] && "defaultOptions" === n) {
            var r, a = s[n],
                l = e[n],
                h = {};
            for (r in a) h[r] = a[r];
        ...
        return ((i.prototype = o).constructor = i).extend = t, i
    }
}(),
function($) {
    "use strict";
    ...
    JQClass.classes.JQPlugin = JQClass.extend({
        ...
        _attach: function(t, e) {
            var i;
            (t = $(t)).hasClass(this._getMarker()) || (t.addClass(this._getMarker()), e = $.extend(this.deepMerge, {}, this.defaultOptions, this._getMetadata(t), e || {}), i = $.extend({
                name: this.name,
                elem: t,
                options: e
        ...
        _getMetadata: function(elem) {
            try {
                var data = elem.data(this.name.toLowerCase()) || "",
                    key, data = data.replace(/(\\?)'/g, function(t, e) {
                        return e ? "'" : '"'
                    }).replace(/([a-zA-Z0-9]+):/g, function(t, e, i) {
                        i = data.substring(0, i).match(/"/g);
                        return i && i.length % 2 != 0 ? e + ":" : '"' + e + '":'
                    }).replace(/\\:/g, ":"),
                    value;
                for (key in data = $.parseJSON("{" + data + "}"), data) {
        ...
        option: function(t, e, i) {
            var n = (t = $(t)).data(this.name),
                s = e || {};
            return !e || "string" == typeof e && void 0 === i ? (s = (n || {}).options) && e ? s[e] : s : void(t.hasClass(this._getMarker()) && ("string" == typeof e && ((s = {})[e] = i), this._optionsChanged(t, n, s), $.extend(n.options, s)))
        },
    ...
    p.JQPlugin.createPlugin({
        ...
        _init: function() {
            ...
            var n = "function" == typeof Date.now ? Date.now : function() {
                ...
                r = 0;
            !o || p.noRequestAnimationFrame ? (p.noRequestAnimationFrame = null, p.countdown._timer = setInterval(function() {
                i._updateElems()
            }, 1e3)) : (r = window.animationStartTime || window.webkitAnimationStartTime || window.mozAnimationStartTime || window.oAnimationStartTime || window.msAnimationStartTime || n(), o(function t(e) {
                e = e < 1e12 ? s ? window.performance.now() + window.performance.timing.navigationStart : n() : e || n();
                1e3 <= e - r && (i._updateElems(), r = e), o(t)
            }))
        },
        UTCDate: function(t, e, i, n, s, o, r, a) {
            "object" == typeof e && e instanceof Date && (a = e.getMilliseconds(), r = e.getSeconds(), o = e.getMinutes(), s = e.getHours(), n = e.getDate(), i = e.getMonth(), e = e.getFullYear());
            var l = new Date;
        ...
        resync: function() {
            ...
            p("." + this._getMarker()).each(function() {
                ...
                if (t.options.serverSync) {
                    for (var e, i = null, n = 0; n < s._serverSyncs.length; n++)
        ...
        _optionsChanged: function(t, e, i) {
            ...
            p.extend(e.options, i), this._adjustSettings(t, e, !this._eqNull(i.until) || !this._eqNull(i.since) || n);
            n = new Date;
        ...
        _adjustSettings: function(t, e, i) {
            ...
            var o = null,
                r = null;
            this._eqNull(n) ? (a = p.isFunction(e.options.serverSync) ? e.options.serverSync.apply(t[0], []) : null, o = new Date, r = a ? o.getTime() - a.getTime() : 0, this._serverSyncs.push([e.options.serverSync, r])) : (o = new Date, r = e.options.serverSync ? n : 0);
            var a = e.options.timezone,
                a = this._eqNull(a) ? -o.getTimezoneOffset() : a;
            (i || !i && this._eqNull(e._until) && this._eqNull(e._since)) && (e._since = e.options.since, this._eqNull(e._since) || (e._since = this.UTCDate(a, this._determineTime(e._since, null)), e._since && r && e._since.setMilliseconds(e._since.getMilliseconds() + r)), e._until = this.UTCDate(a, this._determineTime(e.options.until, o)), r && e._until.setMilliseconds(e._until.getMilliseconds() + r)), e._show = this._determineShow(e)
        },
        _preDestroy: function(t, e) {
        ...
        _hold: function(t, e) {
            var i, n = p.data(t, this.name);
            n && ("pause" !== n._hold || e || (n._periods = n._savePeriods, i = n._since ? "-" : "+", n[n._since ? "_since" : "_until"] = this._determineTime(i + n._periods[0] + "y" + i + n._periods[1] + "o" + i + n._periods[2] + "w" + i + n._periods[3] + "d" + i + n._periods[4] + "h" + i + n._periods[5] + "m" + i + n._periods[6] + "s"), this._addElem(t)), n._hold = e, n._savePeriods = "pause" === e ? n._periods : null, p.data(t, this.name, n), this._updateCountdown(t, n))
        },
        getTimes: function(t) {
        ...
        _determineTime: function(t, e) {
            var i, n, c = this,
                t = this._eqNull(t) ? e : "string" == typeof t ? function(t) {
                    t = t.toLowerCase();
                    for (var e = new Date, i = e.getFullYear(), n = e.getMonth(), s = e.getDate(), o = e.getHours(), r = e.getMinutes(), a = e.getSeconds(), l = /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, h = l.exec(t); h;) {
                        switch (h[2] || "s") {
                            case "s":
                                a += parseInt(h[1], 10);
                                break;
                            ...
                            case "w":
                                ...
                                break;
                            case "o":
                                n += parseInt(h[1], 10), s = Math.min(s, c._getDaysInMonth(i, n));
                                break;
                            case "y":
                                i += parseInt(h[1], 10), s = Math.min(s, c._getDaysInMonth(i, n))
                        }
                        h = l.exec(t)
                    }
                    return new Date(i, n, s, o, r, a, 0)
                }(t) : "number" == typeof t ? (i = t, (n = new Date).setTime(n.getTime() + 1e3 * i), n) : t;
        ...
        _generateHTML: function(i) {
            ...
            for (var t = !1, e = 0, s = i.options.significant, o = p.extend({}, i._show), r = null, r = 0; r <= 6; r++) t = t || "?" === i._show[r] && 0 < i._periods[r], o[r] = "?" !== i._show[r] || t ? i._show[r] : null, e += o[r] ? 1 : 0, s -= 0 < i._periods[r] ? 1 : 0;
            var a = [!1, !1, !1, !1, !1, !1, !1];
            for (r = 6; 0 <= r; r--) i._show[r] && (i._periods[r] ? a[r] = !0 : (a[r] = 0 < s, s--));

            function l(t) {
                var e = i.options["compactLabels" + u(i._periods[t])];
                return o[t] ? n._translateDigits(i, i._periods[t]) + (e || c)[t] + " " : ""
            }

            function h(t) {
                var e = i.options["labels" + u(i._periods[t])];
                return !i.options.significant && o[t] || i.options.significant && a[t] ? '<span class="' + n._sectionClass + '"><span class="' + n._amountClass + '">' + n._minDigits(i, i._periods[t], d) + '</span><span class="' + n._periodClass + '">' + (e || c)[t] + "</span></span>" : ""
            }
            ...
            return i.options.layout ? this._buildLayout(i, o, i.options.layout, i.options.compact, i.options.significant, a) : (i.options.compact ? '<span class="' + this._rowClass + " " + this._amountClass + (i._hold ? " " + this._holdingClass : "") + '">' + l(0) + l(1) + l(2) + l(3) + (o[4] ? this._minDigits(i, i._periods[4], 2) : "") + (o[5] ? (o[4] ? i.options.timeSeparator : "") + this._minDigits(i, i._periods[5], 2) : "") + (o[6] ? (o[4] || o[5] ? i.options.timeSeparator : "") + this._minDigits(i, i._periods[6], 2) : "") : '<span class="' + this._rowClass + " " + this._showClass + (i.options.significant || e) + (i._hold ? " " + this._holdingClass : "") + '">' + h(0) + h(1) + h(2) + h(3) + h(4) + h(5) + h(6)) + "</span>" + (i.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + i.options.description + "</span>" : "")
        },
        _buildLayout: function(i, t, e, n, s, o) {
            for (var r = i.options[n ? "compactLabels" : "labels"], a = i.options.whichLabels || this._normalLabels, l = function(t) {
                    return (i.options[(n ? "compactLabels" : "labels") + a(i._periods[t])] || r)[t]
                }, h = function(t, e) {
        ...
        _calculatePeriods: function(t, i, e, n) {
            ...
            var o, r, a, l = [0, 0, 0, 0, 0, 0, 0];
            (i[0] || i[1]) && (a = this._getDaysInMonth(n.getFullYear(), n.getMonth()), r = this._getDaysInMonth(s.getFullYear(), s.getMonth()), o = s.getDate() === n.getDate() || s.getDate() >= Math.min(a, r) && n.getDate() >= Math.min(a, r), r = function(t) {
                return 60 * (60 * t.getHours() + t.getMinutes()) + t.getSeconds()
            }, r = Math.max(0, 12 * (s.getFullYear() - n.getFullYear()) + s.getMonth() - n.getMonth() + (s.getDate() < n.getDate() && !o || o && r(s) < r(n) ? -1 : 0)), l[0] = i[0] ? Math.floor(r / 12) : 0, l[1] = i[1] ? r - 12 * l[0] : 0, r = (n = new Date(n.getTime())).getDate() === a, a = this._getDaysInMonth(n.getFullYear() + l[0], n.getMonth() + l[1]), n.getDate() > a && n.setDate(a), n.setFullYear(n.getFullYear() + l[0]), n.setMonth(n.getMonth() + l[1]), r && n.setDate(a));
            var h = Math.floor((s.getTime() - n.getTime()) / 1e3),
                c = null,
                n = function(t, e) {
                    l[t] = i[t] ? Math.floor(h / e) : 0, h -= l[t] * e
                };
            if (n(2, 604800), n(3, 86400), n(4, 3600), n(5, 60), n(6, 1), 0 < h && !t._since)
                for (var u = [1, 12, 4.3482, 7, 24, 60, 60], d = 6, p = 1, c = 6; 0 <= c; c--) i[c] && (l[d] >= p && (l[d] = 0, h = 1), 0 < h && (l[c]++, h = 0, d = c, p = 1)), p *= u[c];
            if (e)
...
function() {
    ...
    n.prototype.hasNext = function() {
        ...
        var e, i, n, s, o, r, a, l, h, c, u, d, p, f, m, g, v, _, y, w, b, C, E, x, T, S;
        if ("object" != typeof t) {
        ...
        if (null != this.options.success && "function" == typeof this.options.success && this.options.success.call(this, t), this.context.nextUrl = "", null != t.pagination && (this.context.nextUrl = t.pagination.next_url), "none" !== this.options.sortBy) switch (x = "least" === (T = "random" === this.options.sortBy ? ["", "random"] : this.options.sortBy.split("-"))[0], T[1]) {
            case "random":
        ...
        if ("undefined" != typeof document && null !== document && !1 === this.options.mock) {
            if (d = t.data, T = parseInt(this.options.limit, 10), null != this.options.limit && d.length > T && (d = d.slice(0, T)), r = document.createDocumentFragment(), null != this.options.filter && "function" == typeof this.options.filter && (d = this._filter(d, this.options.filter)), null != this.options.template && "string" == typeof this.options.template) {
                for (a = "", S = document.createElement("div"), l = 0, w = d.length; l < w; l++) {
                    if ("object" != typeof(c = (h = d[l]).images[this.options.resolution])) throw o = "No image found for resolution: " + this.options.resolution + ".", new Error(o);
                    g = c.width, m = (f = c.height) < g ? "landscape" : "square", g < f && (m = "portrait"), u = c.url, 0 <= window.location.protocol.indexOf("http") && !this.options.useHttp && (u = u.replace(/https?:\/\//, "//")), a += this._makeTemplate(this.options.template, {
                        model: h,
                        id: h.id,
                        link: h.link,
                        type: h.type,
                ...
                for (S.innerHTML = a, s = [], n = 0, i = S.childNodes.length; n < i;) s.push(S.childNodes[n]), n += 1;
                for (_ = 0, b = s.length; _ < b; _++) E = s[_], r.appendChild(E)
            } else
                for (y = 0, C = d.length; y < C; y++) {
                    if (h = d[y], p = document.createElement("img"), "object" != typeof(c = h.images[this.options.resolution])) throw o = "No image found for resolution: " + this.options.resolution + ".", new Error(o);
                    u = c.url, 0 <= window.location.protocol.indexOf("http") && !this.options.useHttp && (u = u.replace(/https?:\/\//, "//")), p.src = u, !0 === this.options.links ? ((e = document.createElement("a")).href = h.link, e.appendChild(p), r.appendChild(e)) : r.appendChild(p)
                }
            if (null == (T = "string" == typeof(T = this.options.target) ? document.getElementById(T) : T)) throw o = 'No element with id="' + this.options.target + '" on page.', new Error(o);
            T.appendChild(r), document.getElementsByTagName("head")[0].removeChild(document.getElementById("instafeed-fetcher")), v = "instafeedCache" + this.unique, window[v] = void 0;
            try {
                delete window[v]
            } catch (t) {
                0
    ...
    function(e, i) {
        ...
        function i(l, h, c) {
            (c = c || e || t.jQuery) && (h.prototype.option || (h.prototype.option = function(t) {
                ...
                var n, s, o, r, a, e = u.call(arguments, 1);
                return s = e, r = "$()." + l + '("' + (n = t) + '")', (t = this).each(function(t, e) {
                    var i = c.data(e, l);
                    i ? (e = i[n]) && "_" != n.charAt(0) ? (i = e.apply(i, s), o = void 0 === o ? i : o) : d(r + " is not a valid method") : d(l + " not initialized. Cannot call methods, i.e. " + r)
                }), void 0 !== o ? o : t
            }, n(c))
        }
    ...
    function(t, e) {
        ...
        function m(t) {
            if (y || (y = !0, (d = document.createElement("div")).style.width = "200px", d.style.padding = "1px 2px 3px 4px", d.style.borderStyle = "solid", d.style.borderWidth = "1px 2px 3px 4px", d.style.boxSizing = "border-box", (u = document.body || document.documentElement).appendChild(d), c = f(d), g = 200 == Math.round(p(c.width)), m.isBoxSizeOuter = g, u.removeChild(d)), (t = "string" == typeof t ? document.querySelector(t) : t) && "object" == typeof t && t.nodeType) {
                ...
                n = p(e.height);
                return !1 !== n && (i.height = n + (t ? 0 : l + d)), i.innerWidth = i.width - (a + u), i.innerHeight = i.height - (l + d), i.outerWidth = i.width + h, i.outerHeight = i.height + c, i
            }
            var d, u, c
        }
    ...
    function(t, e) {
        ...
        t.constructor = i, t._create = function() {
            ...
            var t = getComputedStyle(this.element),
                ...
                o = parseFloat(n),
                r = parseFloat(s),
                t = this.layout.size; - 1 != n.indexOf("%") && (o = o / 100 * t.width), -1 != s.indexOf("%") && (r = r / 100 * t.height), o = isNaN(o) ? 0 : o, r = isNaN(r) ? 0 : r, o -= e ? t.paddingLeft : t.paddingRight, r -= i ? t.paddingTop : t.paddingBottom, this.position.x = o, this.position.y = r
            ...
            s = n ? "paddingTop" : "paddingBottom", i = n ? "top" : "bottom", n = n ? "bottom" : "top", s = this.position.y + t[s];
            e[i] = this.getYValue(s), e[n] = "", this.css(e), this.emitEvent("layout", [this])
    ...
    function(s, o) {
        ...
        function r(t, e) {
            ...
            i ? (this.element = i, h && (this.$element = h(this.element)), this.options = n.extend({}, this.constructor.defaults), this.option(e), e = ++c, this.element.outlayerGUID = e, (u[e] = this)._create(), this._getOption("initLayout") && this.layout()) : l && l.error("Bad element for " + this.constructor.namespace + ": " + (i || t))
        }
        ...
        n.extend(d, e.prototype), d.option = function(t) {
            ...
            this.emitEvent(t, n), h && (this.$element = this.$element || h(this.element), e ? ((e = h.Event(e)).type = t, this.$element.trigger(e, i)) : this.$element.trigger(t, i))
        }, d.ignore = function(t) {
            t = this.getItem(t);
            t && (t.isIgnored = !0)
            ...
            var i = a(r);
            return i.defaults = n.extend({}, r.defaults), n.extend(i.defaults, e), i.compatOptions = n.extend({}, r.compatOptions), i.namespace = t, i.data = r.data, i.Item = a(o), n.htmlInit(i, t), h && h.bridget && h.bridget(t, i), i
        };
        var p = {
            ms: 1,
            s: 1e3
    ...
    function(t, e) {
        ...
        return t._resetLayout = function() {
            ...
            for (var e = t.size.outerWidth % this.columnWidth, i = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth), i = Math.min(i, this.cols), n = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, t), e = {
                    ...
                    y: n.y
                }, s = n.y + t.size.outerHeight, o = i + n.col, r = n.col; r < o; r++) this.colYs[r] = s;
            return e
            ...
            for (var o = (this._getOption("originTop") ? i.top : i.bottom) + e.outerHeight, r = n; r <= s; r++) this.colYs[r] = Math.max(o, this.colYs[r])
    ...
    function(r, a) {
        ...
        s._create = function() {
            ...
            for (var e = (e = this.options.filter) || "*", i = [], n = [], s = [], o = this._getFilterTest(e), r = 0; r < t.length; r++) {
                var a, l = t[r];
        ...
        h.sortDataParsers = {
            ...
            var t, r, a;
            this.options.sortBy && (t = o.makeArray(this.options.sortBy), this._getIsSameSortBy(t) || (this.sortHistory = t.concat(this.sortHistory)), r = this.sortHistory, a = this.options.sortAscending, t = function(t, e) {
            ...
            return h(this).each(function(t, e) {
                ...
                s.attr("novalidate", "true"), o.attr("name", "EMAIL"), s.submit(function() {
                    ...
                    h.each(t, function(t, e) {
                        ...
                        data: n,
                        success: function(e) {
                            if ("success" === e.result) i = "We have sent you a confirmation email", r.removeClass("error").addClass("valid"), o.removeClass("error").addClass("valid");
                            else {
                            ...
                            "en" !== a.language && void 0 !== h.ajaxChimp.responses[i] && h.ajaxChimp.translations && h.ajaxChimp.translations[a.language] && h.ajaxChimp.translations[a.language][h.ajaxChimp.responses[i]] && (i = h.ajaxChimp.translations[a.language][h.ajaxChimp.responses[i]]), r.html(i), r.show(2e3), a.callback && a.callback(e)
                        },
                        dataType: "jsonp",
                        error: function(t, e) {
                    ...
                    t = "Submitting...";
                    return "en" !== a.language && h.ajaxChimp.translations && h.ajaxChimp.translations[a.language] && h.ajaxChimp.translations[a.language].submit && (t = h.ajaxChimp.translations[a.language].submit), r.html(t).show(2e3), !1
                })
            }), this
        }
    }(jQuery),
        ...
        i.fn.counterUp = function(t) {
            ...
            return this.each(function() {
                var l = i(this),
                    h = e;
                l.waypoint(function() {
                    for (var t = [], e = h.time / h.delay, i = l.text(), n = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), s = (/^[0-9]+$/.test(i), /^[0-9]+\.[0-9]+$/.test(i)), o = s ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
    ...
    function(t) {
        ...
        t.prototype = {
            ...
            open: function(t) {
                ...
                if (!f.isOpen) {
                    ...
                    d("BeforeOpen"), f.st.showCloseBtn && (f.st.closeBtnInside ? (c(_, function(t, e, i, n) {
                    ...
                    var r = f.wH = C.height(),
                        a = {};
                    f.fixedContentPos && f._hasScrollBar(r) && ((l = f._getScrollbarSize()) && (a.marginRight = l)), f.fixedContentPos && (f.isIE7 ? h("body, html").css("overflow", "hidden") : a.overflow = "hidden");
                    var l = f.st.mainClass;
                    return f.isIE7 && (l += " mfp-ie7"), l && f._addClassToMFP(l), f.updateItemHTML(), d("BuildControls"), h("html").css(a), f.bgOverlay.add(f.wrap).prependTo(f.st.prependTo || h(document.body)), f._lastFocusedEl = document.activeElement, setTimeout(function() {
                        f.content ? (f._addClassToMFP(b), f._setFocus()) : f.bgOverlay.addClass(b), m.on("focusin" + w, f._onFocusIn)
                    }, 16), f.isOpen = !0, f.updateSize(r), d(y), t
                }
                f.updateItemHTML()
            },
            close: function() {
            ...
            updateSize: function(t) {
                var e;
                f.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth, e = window.innerHeight * e, f.wrap.css("height", e), f.wH = e) : f.wH = t || C.height(), f.fixedContentPos || f.wrap.css("height", f.wH), d("Resize")
            },
            updateItemHTML: function() {
                var t = f.items[f.index];
                f.contentContainer.detach(), f.content && f.content.detach();
                var e = (t = !t.parsed ? f.parseEl(f.index) : t).type;
                d("BeforeChange", [f.currItem ? f.currItem.type : "", e]), f.currItem = t, f.currTemplate[e] || (i = !!f.st[e] && f.st[e].markup, d("FirstMarkupParse", i), f.currTemplate[e] = !i || h(i)), s && s !== t.type && f.container.removeClass("mfp-" + s + "-holder");
            ...
            _openClick: function(t, e, i) {
                if ((void 0 !== i.midClick ? i : h.magnificPopup.defaults).midClick || !(2 === t.which || t.ctrlKey || t.metaKey || t.altKey || t.shiftKey)) {
                    var n = (void 0 !== i.disableOn ? i : h.magnificPopup.defaults).disableOn;
                    if (n)
                        if (h.isFunction(n)) {
            ...
            _parseMarkup: function(s, t, e) {
                var o;
                e.data && (t = h.extend(e.data, t)), d(_, [s, t, e]), h.each(t, function(t, e) {
                    return void 0 === e || !1 === e || void(1 < (o = t.split("_")).length ? 0 < (i = s.find(w + "-" + o[0])).length && ("replaceWith" === (n = o[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === n ? i.is("img") ? i.attr("src", e) : i.replaceWith(h("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(o[1], e)) : s.find(w + "-" + t).html(e));
                    var i, n
                })
            },
            ...
            o();
            var e, i, n, s = h(this);
            return "string" == typeof t ? "open" === t ? (e = a ? s.data("magnificPopup") : s[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, n = e.items ? e.items[i] : (n = s, (n = e.delegate ? n.find(e.delegate) : n).eq(i)), f._openClick({
                mfpEl: n
            }, s, e)) : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1)) : (t = h.extend(!0, {}, t), a ? s.data("magnificPopup", t) : s[0].magnificPopup = t, f.addGroup(s, t)), s
        };
            ...
            proto: {
                ...
                getInline: function(t, e) {
                    if (E(), t.src) {
                        var i, n = f.st.inline,
                            s = h(t.src);
                        return s.length ? ((i = s[0].parentNode) && i.tagName && (T || (x = n.hiddenClass, T = u(x), x = "mfp-" + x), S = s.after(T).detach().removeClass(x)), f.updateStatus("ready")) : (f.updateStatus("error", n.tNotFound), s = h("<div>")), t.inlineElement = s
                    }
        ...
        h.magnificPopup.registerModule(O, {
            ...
            proto: {
                initAjax: function() {
                    f.types.push(O), k = f.st.ajax.cursor, c(l + "." + O, A), c("BeforeChange." + O, A)
                },
                getAjax: function(n) {
                    k && h(document.body).addClass(k), f.updateStatus("loading");
                    var t = h.extend({
                        url: n.src,
                        success: function(t, e, i) {
                            ...
                            d("ParseAjax", i), f.appendContent(h(i.data), O), n.finished = !0, D(), f._setFocus(), setTimeout(function() {
                                f.wrap.addClass(b)
                            }, 16), f.updateStatus("ready"), d("AjaxContentAdded")
                        },
                        error: function() {
                            D(), n.finished = n.loadError = !0, f.updateStatus("error", f.st.ajax.tError.replace("%url%", n.src))
                        }
                    }, f.st.ajax.settings);
        ...
        h.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function() {
                    var t = f.st.image,
                        e = ".image";
                    f.types.push("image"), c(y + e, function() {
                    ...
                    var i = 0,
                        ...
                        s = function(t) {
                            L && clearInterval(L), L = setInterval(function() {
                                return 0 < n.naturalWidth ? void f._onImageHasSize(e) : (200 < i && clearInterval(L), void(3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)))
                            }, t)
                        };
                    s(1)
                },
                getImage: function(t, e) {
                    var i, n = 0,
                        s = function() {
                            t && (t.img[0].complete ? (t.img.off(".mfploader"), t === f.currItem && (f._onImageHasSize(t), f.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, d("ImageLoadComplete")) : ++n < 200 ? setTimeout(s, 100) : o())
                        },
                        o = function() {
                        ...
                        r = f.st.image,
                        a = e.find(".mfp-img");
                    return a.length && ((i = document.createElement("img")).className = "mfp-img", t.el && t.el.find("img").length && (i.alt = t.el.find("img").attr("alt")), t.img = h(i).on("load.mfploader", s).on("error.mfploader", o), i.src = t.src, a.is("img") && (t.img = t.img.clone()), 0 < (i = t.img[0]).naturalWidth ? t.hasSize = !0 : i.width || (t.hasSize = !1)), f._parseMarkup(e, {
                        title: function(t) {
        ...
        h.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                initZoom: function() {
                    var t, e, i, n, s, o, r = f.st.zoom,
                        a = ".zoom";
                    r.enabled && f.supportsTransition && (n = r.duration, s = function(t) {
                ...
                _getOffset: function(t) {
                    ...
                    return (z = void 0 === z ? void 0 !== document.createElement("p").style.MozTransform : z) ? n["-moz-transform"] = n.transform = "translate(" + i.left + "px," + i.top + "px)" : (n.left = i.left, n.top = i.top), n
                }
            }
        });
        ...
        function P(t) {
            var e;
            !f.currTemplate[N] || (e = f.currTemplate[N].find("iframe")).length && (t || (e[0].src = "//about:blank"), f.isIE8 && e.css("display", t ? "block" : "none"))
        }
        var N = "iframe";
        h.magnificPopup.registerModule(N, {
            ...
            proto: {
                initIframe: function() {
                    f.types.push(N), c("BeforeChange", function(t, e, i) {
                        e !== i && (e === N ? P() : i === N && P(!0))
                    }), c(l + "." + N, function() {
                        P()
                    })
        ...
        h.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    var o = f.st.gallery,
                        t = ".mfp-gallery";
                    return f.direction = !0, !(!o || !o.enabled) && (g += " mfp-gallery", c(y + t, function() {
                        ...
                        e.text && (e.text = M(e.text, f.currItem.index, f.items.length))
                    }), c(_ + t, function(t, e, i, n) {
                        var s = f.items.length;
                        i.counter = 1 < s ? M(o.tCounter, n.index, s) : ""
                    }), c("BuildControls" + t, function() {
                        var t, e;
                        1 < f.items.length && o.arrows && !f.arrowLeft && (e = o.arrowMarkup, t = f.arrowLeft = h(e.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")).addClass(r), e = f.arrowRight = h(e.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")).addClass(r), t.click(function() {
                            f.prev()
                        }), e.click(function() {
                            f.next()
                ...
                _preloadItem: function(t) {
                    var e;
                    t = j(t), f.items[t].preloaded || ((e = f.items[t]).parsed || (e = f.parseEl(t)), d("LazyLoad", e), "image" === e.type && (e.img = h('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0
        ...
        h.magnificPopup.registerModule(H, {
            ...
            proto: {
                initRetina: function() {
                    var i, n;
                    1 < window.devicePixelRatio && (i = f.st.retina, n = i.ratio, 1 < (n = isNaN(n) ? n() : n) && (c("ImageHasSize." + H, function(t, e) {
                        e.img.css({
    ...
    function(s) {
        s.fn.niceSelect = function(t) {
            function n(t) {
                ...
                n.find(".current").html(t.data("display") || t.text()), e.each(function(t) {
                    var e = s(this),
                        i = e.data("display");
        ...
        c.extend(c.fn, {
            ...
            rules: function(t, e) {
                ...
                if (null != a && (!a.form && l && (a.form = this.closest("form")[0], a.name = this.attr("name")), null != a.form)) {
                    if (t) switch (i = c.data(a.form, "validator").settings, n = i.rules, s = c.validator.staticRules(a), t) {
                        case "add":
                            c.extend(s, c.validator.normalizeRule(e)), delete s.messages, n[a.name] = s, e.messages && (i.messages[a.name] = c.extend(i.messages[a.name], e.messages));
                            break;
                        case "remove":
                    ...
                    return (t = c.validator.normalizeRules(c.extend({}, c.validator.classRules(a), c.validator.attributeRules(a), c.validator.dataRules(a), c.validator.staticRules(a)), a)).required && (o = t.required, delete t.required, t = c.extend({
                        required: o
                    }, t)), t.remote && (o = t.remote, delete t.remote, t = c.extend(t, {
                        remote: o
                    })), t
                }
            }
            ...
            prototype: {
                init: function() {
                    function t(t) {
                        var e, i, n = void 0 !== c(this).attr("contenteditable") && "false" !== c(this).attr("contenteditable");
                        !this.form && n && (this.form = c(this).closest("form")[0], this.name = c(this).attr("name")), s === this.form && (e = c.data(this.form, "validator"), i = "on" + t.type.replace(/^validate/, ""), (n = e.settings)[i] && !c(this).is(n.ignore) && n[i].call(e, this, t))
                    }
            ...
            attributeRules: function(t) {
                ...
                for (e in c.validator.methods) i = "required" === e ? (i = t.getAttribute(e), "" === i && (i = !0), !!i) : s.attr(e), this.normalizeAttributeRule(n, o, e, i);
            ...
            dataRules: function(t) {
                var e, i, n = {},
                    s = c(t),
                    o = t.getAttribute("type");
                for (e in c.validator.methods) i = s.data("rule" + e.charAt(0).toUpperCase() + e.substring(1).toLowerCase()), "" === i && (i = !0), this.normalizeAttributeRule(n, o, e, i);
                return n
            },
            staticRules: function(t) {
                var e = {},
                    i = c.data(t.form, "validator");
                return e = i.settings.rules ? c.validator.normalizeRule(i.settings.rules[t.name]) || {} : e
            },
            ...
            methods: {
                ...
                remote: function(n, s, t, o) {
                    ...
                    var r, e, a = this.previousValue(s, o);
                    return this.settings.messages[s.name] || (this.settings.messages[s.name] = {}), a.originalMessage = a.originalMessage || this.settings.messages[s.name][o], this.settings.messages[s.name][o] = a.message, t = "string" == typeof t ? {
                        url: t
                    } : t, e = c.param(c.extend({
                        data: n
                    }, t.data)), a.old === e ? a.valid : (a.old = e, (r = this).startRequest(s), (e = {})[s.name] = n, c.ajax(c.extend(!0, {
                        mode: "abort",
                        ...
                        success: function(t) {
                            var e, i = !0 === t || "true" === t;
                            r.settings.messages[s.name][o] = a.originalMessage, i ? (e = r.formSubmitted, r.resetInternals(), r.toHide = r.errorsFor(s), r.formSubmitted = e, r.successList.push(s), r.invalid[s.name] = !1, r.showErrors()) : (e = {}, t = t || r.defaultMessage(s, {
                                method: o,
                                parameters: n
                            }), e[s.name] = a.message = t, r.invalid[s.name] = !0, r.showErrors(e)), a.valid = i, r.stopRequest(s, i)
                        }
                    }, t)), "pending")
                }
            }
    ...
    function(l, i, n, a) {
        ...
        h.Defaults = {
            ...
            run: function() {
                for (var t, e, i = this.settings.rtl ? 1 : -1, n = 2 * this.settings.stagePadding, s = this.coordinates(this.current()) + n, o = s + this.width() * i, r = [], a = 0, l = this._coordinates.length; a < l; a++) t = this._coordinates[a - 1] || 0, e = Math.abs(this._coordinates[a]) + n * i, (this.op(t, "<=", s) && this.op(t, ">", o) || this.op(e, "<", s) && this.op(e, ">", o)) && r.push(a);
            ...
            var i, n = this.current(),
                ...
                a = this.minimum(),
                l = this.maximum();
            this.settings.loop ? (!this.settings.rewind && Math.abs(s) > r / 2 && (s += -1 * o * r), (i = (((t = n + s) - a) % r + r) % r + a) !== t && i - s <= l && 0 < i - s && (n = i - s, t = i, this.reset(n))) : t = this.settings.rewind ? (t % (l += 1) + l) % l : Math.max(a, Math.min(l, t)), this.speed(this.duration(n, t, e)), this.current(t), this.isVisible() && this.update()
    ...
    function(c, e) {
        ...
        i.Defaults = {
            ...
            this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), e = this._core.items(this._core.relative(e.index())), this._core.reset(e.index()), (t = c('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", s), t.attr("width", n), "youtube" === i.type ? t.attr("src", "//www.youtube.com/embed/" + i.id + "?autoplay=1&rel=0&v=" + i.id) : "vimeo" === i.type ? t.attr("src", "//player.vimeo.com/video/" + i.id + "?autoplay=1") : "vzaar" === i.type && t.attr("src", "//view.vzaar.com/" + i.id + "/player?autoplay=true"), c(t).wrap('<div class="owl-video-frame" />').insertAfter(e.find(".owl-video")), this._playing = e.addClass("owl-video-playing"))
    ...
    function(r) {
        ...
        e.Defaults = {
            ...
            var t, e, i, n, s, o;
            1 === this.core.settings.items && r.support.animation && r.support.transition && (this.core.speed(0), e = r.proxy(this.clear, this), i = this.core.$stage.children().eq(this.previous), n = this.core.$stage.children().eq(this.next), s = this.core.settings.animateIn, o = this.core.settings.animateOut, this.core.current() !== this.previous && (o && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), i.one(r.support.animation.end, e).css({
                left: t + "px"
    ...
    function(t, e) {
        ...
        function p(t) {
            ...
            var e = u(t),
                ...
                n = e.overflowX,
                e = e.overflowY;
            return /(auto|scroll)/.test(i + e + n) ? t : p(d(t))
        }

        function h(t) {
            var e = t && t.offsetParent,
                t = e && e.nodeName;
            return t && "BODY" !== t && "HTML" !== t ? -1 !== ["TD", "TABLE"].indexOf(e.nodeName) && "static" === u(e, "position") ? h(e) : e : window.document.documentElement
        }
        ...
        function f(t, e) {
            ...
            if (t !== i && e !== i || n.contains(s)) return "BODY" === (s = (n = i).nodeName) || "HTML" !== s && h(n.firstElementChild) !== n ? h(i) : i;
            i = o(t);
            return i.host ? f(i.host, e) : f(t, o(e).host)
        }
        ...
        function m(t, e) {
            ...
            return (window.document.scrollingElement || t)[i]
        }

        function l(t, e) {
            var i = "x" === e ? "Left" : "Top",
                e = "Left" == i ? "Right" : "Bottom";
            return +t["border" + i + "Width"].split("px")[0] + +t["border" + e + "Width"].split("px")[0]
        }

        function n(t, e, i, n) {
            return z(e["offset" + t], i["client" + t], i["offset" + t], B() ? i["offset" + t] + n["margin" + ("Height" === t ? "Top" : "Left")] + n["margin" + ("Height" === t ? "Bottom" : "Right")] : 0)
        }
        ...
        function c(t) {
            ...
            var s = {
                ...
                o = t.offsetWidth - r,
                r = t.offsetHeight - a;
            return (o || r) && (o -= l(a = u(t), "x"), r -= l(a, "y"), s.width -= o, s.height -= r), v(s)
        }
        ...
        function _(t, e) {
            var i = B(),
                ...
                t = +a.borderLeftWidth.split("px")[0],
                s = v({
                    top: s.top - o.top - l,
                    left: s.left - o.left - t,
                    width: s.width,
                    height: s.height
                });
            return s.marginTop = 0, s.marginLeft = 0, !i && n && (n = +a.marginTop.split("px")[0], a = +a.marginLeft.split("px")[0], s.top -= l - n, s.bottom -= l - n, s.left -= t - a, s.right -= t - a, s.marginTop = n, s.marginLeft = a), s = (i ? e.contains(r) : e === r && "BODY" !== r.nodeName) ? function(t, e, i) {
        ...
        function a(t, e, i, n) {
            var s, o, r, a, l, h = {
                ...
                c = f(t, e);
            return "viewport" === n ? (o = c, r = window.document.documentElement, a = _(o, r), l = z(r.clientWidth, window.innerWidth || 0), e = z(r.clientHeight, window.innerHeight || 0), o = m(r), r = m(r, "left"), h = v({
                top: o - a.top + a.marginTop,
                left: r - a.left + a.marginLeft,
                width: l,
                height: e
            })) : ("scrollParent" === n ? "BODY" === (s = p(d(t))).nodeName && (s = window.document.documentElement) : s = "window" === n ? window.document.documentElement : n, n = _(s, c), "HTML" !== s.nodeName || function t(e) {
                var i = e.nodeName;
                return "BODY" !== i && "HTML" !== i && ("fixed" === u(e, "position") || t(d(e)))
            }(c) ? h = n : (c = (s = g()).height, s = s.width, h.top += n.top - n.marginTop, h.bottom = c + n.top, h.left += n.left - n.marginLeft, h.right = s + n.left)), h.left += i, h.top += i, h.right -= i, h.bottom -= i, h
        }
        ...
        function C(t, e, i) {
            ...
            var n = w(t),
                ...
                t = o ? "height" : "width",
                o = o ? "width" : "height";
            return s[r] = e[r] + e[t] / 2 - n[t] / 2, s[a] = i === a ? e[a] - n[o] : e[b(a)], s
        }
        ...
        function x(t, i, e) {
            return (void 0 === e ? t : t.slice(0, function(t, e, i) {
                ...
                t.enabled && s(e) && (i.offsets.popper = v(i.offsets.popper), i.offsets.reference = v(i.offsets.reference), i = e(i, t))
            }), i
        }
        ...
        function e(t, e, i, n) {
            ...
            return function t(e, i, n, s) {
                ...
                e.addEventListener(i, n, {
                    passive: !0
                }), o || t(p(e.parentNode), i, n, s), s.push(e)
        ...
        function I(i, n) {
            Object.keys(n).forEach(function(t) {
                var e = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && S(n[t]) && (e = "px"), i.style[t] = n[t] + e
            })
        }
        ...
        function A(t, e) {
            e = 1 < arguments.length && void 0 !== e && e, t = K.indexOf(t), t = K.slice(t + 1).concat(K.slice(0, t));
            ...
            return (-1 === e ? [i] : [i.slice(0, e).concat([i[e].split(t)[0]]), [i[e].split(t)[1]].concat(i.slice(e + 1))]).map(function(t, e) {
                ...
                return t.reduce(function(t, e) {
                    ...
                    return function(t, e, i, n) {
                        var s, o = +(r = t.match(/((?:\-|\+)?\d*\.?\d*)(.*)/))[1],
                            r = r[2];
                        if (!o) return t;
                        if (0 !== r.indexOf("%")) return "vh" !== r && "vw" !== r ? o : ("vh" === r ? z(document.documentElement.clientHeight, window.innerHeight || 0) : z(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * o;
                        switch (r) {
                            case "%p":
                                s = i;
                                break;
        ...
        for (var O = Math.min, L = Math.floor, z = Math.max, P = ["native code", "[object MutationObserverConstructor]"], N = "undefined" != typeof window, j = ["Edge", "Trident", "Firefox"], M = 0, H = 0; H < j.length; H += 1)
            if (N && 0 <= navigator.userAgent.indexOf(j[H])) {
                M = 1;
                break
            }
        function R(t, e, i) {
        ...
        var W, q, F = N && (q = window.MutationObserver, P.some(function(t) {
                return -1 < (q || "").toString().indexOf(t)
            })) ? function(t) {
                var e = !1,
                    i = 0,
            ...
            B = function() {
                return W = null == W ? -1 !== navigator.appVersion.indexOf("MSIE 10") : W
            },
            $ = function(t, e) {
                ...
                value: function() {
                    return function() {
                        ...
                        this.state.isDestroyed || ((t = {
                            ...
                            flipped: !1,
                            offsets: {}
                        }).offsets.reference = y(this.state, this.popper, this.reference), t.placement = r(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.offsets.popper = C(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = "absolute", t = x(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t)))
                    }.call(this)
                }
            }, {
                key: "destroy",
        ...
        function X(t, e) {
            ...
            $(this, X), this.scheduleUpdate = function() {
                return requestAnimationFrame(i.update)
            }, this.update = F(this.update.bind(this)), this.options = Q({}, X.Defaults, n), this.state = {
                isDestroyed: !1,
                isCreated: !1,
                scrollParents: []
            }, this.reference = t.jquery ? t[0] : t, this.popper = e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(Q({}, X.Defaults.modifiers, n.modifiers)).forEach(function(t) {
                i.options.modifiers[t] = Q({}, X.Defaults.modifiers[t] || {}, n.modifiers ? n.modifiers[t] : {})
        ...
        return U.Utils = ("undefined" == typeof window ? global : window).PopperUtils, U.placements = Y, U.Defaults = {
            placement: "bottom",
            eventsEnabled: !0,
            removeOnDestroy: !1,
            onCreate: function() {},
            ...
            modifiers: {
                shift: {
                    ...
                    fn: function(t) {
                        var e, i, n = t.placement,
                            s = n.split("-")[0],
                            o = n.split("-")[1];
                        return o && (e = (i = t.offsets).reference, n = i.popper, s = (i = -1 !== ["bottom", "top"].indexOf(s)) ? "width" : "height", s = {
                            start: R({}, i = i ? "left" : "top", e[i]),
                            end: R({}, i, e[i] + e[s] - n[s])
                        }, t.offsets.popper = Q({}, n, s[o])), t
                    }
                },
                offset: {
                    order: 200,
                    ...
                    fn: function(t, e) {
                        var i = e.offset,
                            ...
                            n = n.split("-")[0],
                            s = S(+i) ? [+i, 0] : k(i, e, s, n);
                        return "left" === n ? (e.top += s[0], e.left -= s[1]) : "right" === n ? (e.top += s[0], e.left += s[1]) : "top" === n ? (e.left += s[0], e.top -= s[1]) : "bottom" === n && (e.left += s[0], e.top += s[1]), t.popper = e, t
                    },
                    offset: 0
                },
                preventOverflow: {
                    ...
                    enabled: !0,
                    fn: function(t, n) {
                        var e = n.boundariesElement || h(t.instance.popper);
                        t.instance.reference === e && (e = h(e));
                        var s = a(t.instance.popper, t.instance.reference, n.padding, e);
                        n.boundaries = s;
                        var e = n.priority,
                            o = t.offsets.popper,
                            i = {
                                primary: function(t) {
                                    var e = o[t];
                                    return o[t] < s[t] && !n.escapeWithReference && (e = z(o[t], s[t])), R({}, t, e)
                                },
                                secondary: function(t) {
                                    var e = "right" === t ? "left" : "top",
                                        i = o[e];
                                    return o[t] > s[t] && !n.escapeWithReference && (i = O(o[e], s[t] - ("right" === t ? o.width : o.height))), R({}, e, i)
                                }
                            };
                ...
                keepTogether: {
                    ...
                    fn: function(t) {
                        var e = t.offsets,
                            ...
                            s = r ? "left" : "top",
                            r = r ? "width" : "height";
                        return i[e] < o(n[s]) && (t.offsets.popper[s] = o(n[s]) - i[r]), i[s] > o(n[e]) && (t.offsets.popper[s] = o(n[e])), t
                    }
                },
                arrow: {
                    order: 500,
                    ...
                    fn: function(t, e) {
                        ...
                        var n = t.placement.split("-")[0],
                            ...
                            n = a ? "bottom" : "right",
                            a = w(i)[l];
                        r[n] - a < o[e] && (t.offsets.popper[e] -= o[e] - (r[n] - a)), r[e] + a > o[n] && (t.offsets.popper[e] += r[e] + a - o[n]);
                        r = r[e] + r[l] / 2 - a / 2 - v(t.offsets.popper)[e], r = z(O(o[l] - a, r), 0);
                        return t.arrowElement = i, t.offsets.arrow = {}, t.offsets.arrow[e] = Math.round(r), t.offsets.arrow[s] = "", t
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function(l, h) {
                        ...
                        var c = a(l.instance.popper, l.instance.reference, h.padding, h.boundariesElement),
                        ...
                        return f.forEach(function(t, e) {
                            ...
                            u = l.placement.split("-")[0], d = b(u);
                            var i = l.offsets.popper,
                                n = l.offsets.reference,
                                s = L,
                                o = "left" === u && s(i.right) > s(n.left) || "right" === u && s(i.left) < s(n.right) || "top" === u && s(i.bottom) > s(n.top) || "bottom" === u && s(i.top) < s(n.bottom),
                                r = s(i.left) < s(c.left),
                                a = s(i.right) > s(c.right),
                                t = s(i.top) < s(c.top),
                                n = s(i.bottom) > s(c.bottom),
                                i = "left" === u && r || "right" === u && a || "top" === u && t || "bottom" === u && n,
                                s = -1 !== ["top", "bottom"].indexOf(u),
                                n = !!h.flipVariations && (s && "start" === p && r || s && "end" === p && a || !s && "start" === p && t || !s && "end" === p && n);
                            (o || i || n) && (l.flipped = !0, (o || i) && (u = f[e + 1]), n && (p = "end" === (n = p) ? "start" : "start" === n ? "end" : n), l.placement = u + (p ? "-" + p : ""), l.offsets.popper = Q({}, l.offsets.popper, C(l.instance.popper, l.offsets.reference, l.placement)), l = x(l.instance.modifiers, l, "flip"))
                        }), l
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                inner: {
                    ...
                    fn: function(t) {
                        ...
                        return s[n ? "left" : "top"] = o[e] - (i ? s[n ? "width" : "height"] : 0), t.placement = b(e), t.offsets.popper = v(s), t
                    }
                },
                hide: {
                    order: 800,
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        ...
                        var r = void 0 === o ? e.gpuAcceleration : o,
                            a = c(h(t.instance.popper)),
                            l = {
                                position: s.position
                            },
                            e = {
                            ...
                            i = T("transform"),
                            n = "bottom" == o ? -a.height + e.bottom : e.top,
                            e = "right" == s ? -a.width + e.right : e.left;
                        r && i ? (l[i] = "translate3d(" + e + "px, " + n + "px, 0)", l[o] = 0, l[s] = 0, l.willChange = "transform") : (r = "bottom" == o ? -1 : 1, i = "right" == s ? -1 : 1, l[o] = n * r, l[s] = e * i, l.willChange = o + ", " + s);
                        s = {
                            "x-placement": t.placement
                        };
                        return t.attributes = Q({}, s, t.attributes), t.styles = Q({}, l, t.styles), t
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
                ...
                applyStyle: {
                    ...
                    enabled: !0,
                    fn: function(t) {
                        return I(t.instance.popper, t.styles), e = t.instance.popper, i = t.attributes, Object.keys(i).forEach(function(t) {
                            !1 === i[t] ? e.removeAttribute(t) : e.setAttribute(t, i[t])
                        }), t.offsets.arrow && I(t.arrowElement, t.offsets.arrow), t;
                        var e, i
                    },
                    onLoad: function(t, e, i, n, s) {
                        var o = y(0, e, t),
                            t = r(i.placement, o, e, t, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
                        return e.setAttribute("x-placement", t), I(e, {
                            position: "absolute"
                        }), i
                    },
